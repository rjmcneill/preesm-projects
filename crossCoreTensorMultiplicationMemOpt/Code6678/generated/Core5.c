...
extern char *const broadcastTensorB_1__multiply__0;  // broadcastTensorB_1 > multiplyTensors_10 size:= 256*char defined in Core0
...
extern int *const output_128__arrayB__0;  // broadcastTensorB_1_output_128 > multiplyTensors_10_arrayB size:= 64*int defined in Core0
...
void core5(void){
	...
	while(1){
		...
		receiveStart(); // Core7 > Core5: broadcastTensorB_0__multiply__2 
		receiveEnd(7); // Core7 > Core5: broadcastTensorB_0__multiply__2 
		cache_inv(broadcastTensorB_0__multiply__2, 256*sizeof(char));
		receiveStart(); // Core0 > Core5: broadcastTensorB_1__multiply__0 
		receiveEnd(0); // Core0 > Core5: broadcastTensorB_1__multiply__0 
		cache_inv(broadcastTensorB_1__multiply__0, 256*sizeof(char));
		multiply(8/*rowsA*/,8/*columnsA*/,2/*depthA*/,8/*rowsB*/,8/*columnsB*/,2/*depthB*/,arrayA_80__arrayA__0,output_128__arrayB__0,arrayC__arrayC_80__0); // multiplyTensors_10
		...
		sendStart(2); // Core5 > Core2: multiplyTensors_3__implode_d__0 
		sendEnd(); // Core5 > Core2: multiplyTensors_3__implode_d__0 
	}
}
