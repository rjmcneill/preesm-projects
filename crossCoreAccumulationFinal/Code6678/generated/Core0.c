...
extern char *const FIFO_Head_broadcastOutput_en__7;  // FIFO_Head_broadcastOutput_end_output1_1536 > accumulateMatrices_3_init_runningTotal size:= 2048*char defined in Core1
...
char *const broadcastOutput__broadcastOu__7 = (char*) (SharedMem+100608);  // broadcastOutput > broadcastOutput_end_output1_2560 size:= 2048*char
...
char *const explode_generateMatrices_sta__4 = (char*) (SharedMem+92352);  // explode_generateMatrices_startArray > accumulateMatrices_1 size:= 2048*char
char *const explode_generateMatrices_sta__1 = (char*) (SharedMem+61440);  // explode_generateMatrices_startArray > accumulateMatrices_5 size:= 2048*char
char *const broadcastOutput__broadcastOu__2 = (char*) (SharedMem+88256);  // broadcastOutput > broadcastOutput_end_output1_3584 size:= 2048*char
...
char *const broadcastOutput__broadcastOu__3 = (char*) (SharedMem+80064);  // broadcastOutput > broadcastOutput_end_output1_3072 size:= 2048*char
char *const broadcastOutput__broadcastOu__4 = (char*) (SharedMem+96512);  // broadcastOutput > broadcastOutput_end_output1_2048 size:= 2048*char
...
char *const explode_generateMatrices_sta__2 = (char*) (SharedMem+4096);  // explode_generateMatrices_startArray > accumulateMatrices_7 size:= 2048*char
...
char *const broadcastOutput__broadcastOu__0 = (char*) (SharedMem+123264);  // broadcastOutput > broadcastOutput_end_output1_1024 size:= 2048*char
...
char *const explode_generateMatrices_sta__6 = (char*) (SharedMem+55296);  // explode_generateMatrices_startArray > accumulateMatrices_4 size:= 2048*char
...
char *const broadcastOutput__broadcastOu__6 = (char*) (SharedMem+63552);  // broadcastOutput > broadcastOutput_end_output1_512 size:= 2048*char
char *const explode_generateMatrices_sta__5 = (char*) (SharedMem+10240);  // explode_generateMatrices_startArray > accumulateMatrices_0 size:= 2048*char
...
char *const explode_generateMatrices_sta__0 = (char*) (SharedMem+125376);  // explode_generateMatrices_startArray > accumulateMatrices_2 size:= 2048*char
...
char *const explode_generateMatrices_sta__7 = (char*) (SharedMem+6144);  // explode_generateMatrices_startArray > accumulateMatrices_6 size:= 2048*char
...
char *const broadcastOutput__broadcastOu__5 = (char*) (SharedMem+90304);  // broadcastOutput > broadcastOutput_end_output1_1536 size:= 2048*char
...
char *const explode_generateMatrices_sta__3 = (char*) (SharedMem+34816);  // explode_generateMatrices_startArray > accumulateMatrices_3 size:= 2048*char
...
long *const countOut__end_in__0 = (long*) (SharedMem+123200);  // displayMatrices_countOut > displayMatrices_end_countOut_end_in size:= 1*long
...
long *const init_out__runningTotal__6 = (long*) (SharedMem+2048);  // accumulateMatrices_1_init_runningTotal_init_out > accumulateMatrices_1_runningTotal size:= 512*long
long *const init_out__runningTotal__7 = (long*) (SharedMem+12288);  // accumulateMatrices_3_init_runningTotal_init_out > accumulateMatrices_3_runningTotal size:= 512*long
...
long *const init_out__runningTotal__3 = (long*) (SharedMem+65600);  // accumulateMatrices_2_init_runningTotal_init_out > accumulateMatrices_2_runningTotal size:= 512*long
...
long *const init_out__runningTotal__4 = (long*) (SharedMem+84160);  // accumulateMatrices_6_init_runningTotal_init_out > accumulateMatrices_6_runningTotal size:= 512*long
...
long *const init_out__runningTotal__0 = (long*) (SharedMem+129472);  // accumulateMatrices_5_init_runningTotal_init_out > accumulateMatrices_5_runningTotal size:= 512*long
...
long *const init_out__runningTotal__1 = (long*) (SharedMem+8192);  // accumulateMatrices_4_init_runningTotal_init_out > accumulateMatrices_4_runningTotal size:= 512*long
long *const init_out__runningTotal__5 = (long*) (SharedMem+94400);  // accumulateMatrices_0_init_runningTotal_init_out > accumulateMatrices_0_runningTotal size:= 512*long
...
long *const countOut__end_in__1 = (long*) (SharedMem+69696);  // generateMatrices_countOut > generateMatrices_end_countOut_end_in size:= 1*long
...
void core0(void){
	...
	while(1){
		...
		fifoPop(init_out__runningTotal__4, FIFO_Head_broadcastOutput_en__2, 2048*sizeof(char), NULL, 0);
		cache_wbInv(accumulateMatrices_6_init_ru__0, 2048*sizeof(char));
		sendStart(3); // Core0 > Core3: accumulateMatrices_6_init_ru__0 
		sendEnd(); // Core0 > Core3: accumulateMatrices_6_init_ru__0 
		...
		generate(64/*rows*/,64/*columns*/,startArray__inputArray__0,startTime__startTime__0,init_out__countIn__0,countOut__end_in__1); // generateMatrices
		...
		add(64/*rows*/,64/*columns*/,init_out__runningTotal__1,startArray_2048__inputArray__0,output__input_2048__0); // accumulateMatrices_4
		...
		display(64/*rows*/,64/*columns*/,output2__outputArray__0,startTime__startTime__0,init_out__countIn__1,countOut__end_in__0); // displayMatrices
