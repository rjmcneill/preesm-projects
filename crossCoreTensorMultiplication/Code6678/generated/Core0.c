...
char *const explode_generateTensors_arra__1 = (char*) (SharedMem+188743680);  // explode_generateTensors_arrayA > multiplyTensors_12 size:= 2097152*char
char *const broadcastTensorB_0__multiply__0 = (char*) (SharedMem+413139008);  // broadcastTensorB_0 > multiplyTensors_7 size:= 16777216*char
char *const broadcastTensorB_1__multiply__6 = (char*) (SharedMem+329252928);  // broadcastTensorB_1 > multiplyTensors_13 size:= 16777216*char
char *const broadcastTensorB_0__multiply__1 = (char*) (SharedMem+35651584);  // broadcastTensorB_0 > multiplyTensors_0 size:= 16777216*char
char *const explode_generateTensors_arra__14 = (char*) (SharedMem+394264640);  // explode_generateTensors_arrayA > multiplyTensors_7 size:= 2097152*char
char *const broadcastTensorB_0__multiply__4 = (char*) (SharedMem+16777216);  // broadcastTensorB_0 > multiplyTensors_6 size:= 16777216*char
char *const explode_generateTensors_arra__17 = (char*) (SharedMem+293601344);  // explode_generateTensors_arrayB > broadcastTensorB_1 size:= 16777216*char
...
char *const broadcastTensorB_0__multiply__2 = (char*) (SharedMem+190840832);  // broadcastTensorB_0 > multiplyTensors_1 size:= 16777216*char
...
char *const explode_generateTensors_arra__13 = (char*) (SharedMem+184549376);  // explode_generateTensors_arrayA > multiplyTensors_15 size:= 2097152*char
...
char *const explode_generateTensors_arra__10 = (char*) (SharedMem+207618048);  // explode_generateTensors_arrayA > multiplyTensors_3 size:= 2097152*char
...
char *const explode_generateTensors_arra__5 = (char*) (SharedMem+96468992);  // explode_generateTensors_arrayA > multiplyTensors_10 size:= 2097152*char
char *const explode_generateTensors_arra__16 = (char*) (SharedMem+392167488);  // explode_generateTensors_arrayA > multiplyTensors_0 size:= 2097152*char
char *const generateTensors__explode_gen__1 = (char*) (SharedMem+134217728);  // generateTensors > explode_generateTensors_arrayB size:= 33554432*char
char *const broadcastTensorB_1__multiply__5 = (char*) (SharedMem+77594624);  // broadcastTensorB_1 > multiplyTensors_12 size:= 16777216*char
...
char *const broadcastTensorB_0__multiply__3 = (char*) (SharedMem+226492480);  // broadcastTensorB_0 > multiplyTensors_5 size:= 16777216*char
char *const broadcastTensorB_1__multiply__1 = (char*) (SharedMem+167772160);  // broadcastTensorB_1 > multiplyTensors_11 size:= 16777216*char
char *const broadcastTensorB_0__multiply__7 = (char*) (SharedMem+276824128);  // broadcastTensorB_0 > multiplyTensors_3 size:= 16777216*char
char *const explode_generateTensors_arra__9 = (char*) (SharedMem+373293120);  // explode_generateTensors_arrayA > multiplyTensors_13 size:= 2097152*char
char *const explode_generateTensors_arra__6 = (char*) (SharedMem+429916224);  // explode_generateTensors_arrayA > multiplyTensors_11 size:= 2097152*char
...
char *const broadcastTensorB_0__multiply__6 = (char*) (SharedMem+0);  // broadcastTensorB_0 > multiplyTensors_2 size:= 16777216*char
char *const broadcastTensorB_1__multiply__0 = (char*) (SharedMem+375390272);  // broadcastTensorB_1 > multiplyTensors_8 size:= 16777216*char
char *const explode_generateTensors_arra__8 = (char*) (SharedMem+310378560);  // explode_generateTensors_arrayA > multiplyTensors_6 size:= 2097152*char
char *const explode_generateTensors_arra__12 = (char*) (SharedMem+450887744);  // explode_generateTensors_arrayA > multiplyTensors_2 size:= 2097152*char
char *const broadcastTensorB_1__multiply__7 = (char*) (SharedMem+452984896);  // broadcastTensorB_1 > multiplyTensors_14 size:= 16777216*char
char *const explode_generateTensors_arra__2 = (char*) (SharedMem+432013376);  // explode_generateTensors_arrayA > multiplyTensors_4 size:= 2097152*char
...
char *const broadcastTensorB_0__multiply__5 = (char*) (SharedMem+396361792);  // broadcastTensorB_0 > multiplyTensors_4 size:= 16777216*char
...
char *const explode_generateTensors_arra__4 = (char*) (SharedMem+186646528);  // explode_generateTensors_arrayA > multiplyTensors_1 size:= 2097152*char
char *const explode_generateTensors_arra__3 = (char*) (SharedMem+369098816);  // explode_generateTensors_arrayA > multiplyTensors_9 size:= 2097152*char
char *const explode_generateTensors_arra__7 = (char*) (SharedMem+350224448);  // explode_generateTensors_arrayB > broadcastTensorB_0 size:= 16777216*char
char *const explode_generateTensors_arra__11 = (char*) (SharedMem+371195968);  // explode_generateTensors_arrayA > multiplyTensors_14 size:= 2097152*char
char *const broadcastTensorB_1__multiply__4 = (char*) (SharedMem+54525952);  // broadcastTensorB_1 > multiplyTensors_15 size:= 16777216*char
char *const generateTensors__explode_gen__0 = (char*) (SharedMem+243269696);  // generateTensors > explode_generateTensors_arrayA size:= 33554432*char
...
char *const explode_generateTensors_arra__15 = (char*) (SharedMem+132120576);  // explode_generateTensors_arrayA > multiplyTensors_8 size:= 2097152*char
char *const broadcastTensorB_1__multiply__2 = (char*) (SharedMem+434110528);  // broadcastTensorB_1 > multiplyTensors_9 size:= 16777216*char
char *const explode_generateTensors_arra__0 = (char*) (SharedMem+322961472);  // explode_generateTensors_arrayA > multiplyTensors_5 size:= 2097152*char
char *const broadcastTensorB_1__multiply__3 = (char*) (SharedMem+209715264);  // broadcastTensorB_1 > multiplyTensors_10 size:= 16777216*char
...
int *const output_0__arrayB__1 = (int*) (SharedMem+35651584);  // broadcastTensorB_0_output_0 > multiplyTensors_0_arrayB size:= 4194304*int
...
int *const output_25165824__arrayB__1 = (int*) (SharedMem+452984896);  // broadcastTensorB_1_output_25165824 > multiplyTensors_14_arrayB size:= 4194304*int
...
int *const output_12582912__arrayB__0 = (int*) (SharedMem+167772160);  // broadcastTensorB_1_output_12582912 > multiplyTensors_11_arrayB size:= 4194304*int
int *const output_4194304__arrayB__1 = (int*) (SharedMem+190840832);  // broadcastTensorB_0_output_4194304 > multiplyTensors_1_arrayB size:= 4194304*int
...
int *const output_4194304__arrayB__0 = (int*) (SharedMem+434110528);  // broadcastTensorB_1_output_4194304 > multiplyTensors_9_arrayB size:= 4194304*int
...
int *const output_0__arrayB__0 = (int*) (SharedMem+375390272);  // broadcastTensorB_1_output_0 > multiplyTensors_8_arrayB size:= 4194304*int
int *const output_8388608__arrayB__1 = (int*) (SharedMem+0);  // broadcastTensorB_0_output_8388608 > multiplyTensors_2_arrayB size:= 4194304*int
...
int *const output_12582912__arrayB__1 = (int*) (SharedMem+276824128);  // broadcastTensorB_0_output_12582912 > multiplyTensors_3_arrayB size:= 4194304*int
int *const output_25165824__arrayB__0 = (int*) (SharedMem+16777216);  // broadcastTensorB_0_output_25165824 > multiplyTensors_6_arrayB size:= 4194304*int
...
int *const output_8388608__arrayB__0 = (int*) (SharedMem+209715264);  // broadcastTensorB_1_output_8388608 > multiplyTensors_10_arrayB size:= 4194304*int
...
void core0(void){
	...
	while(1){
		...
		cache_wbInv(explode_generateTensors_arra__13, 2097152*sizeof(char));
		sendStart(2); // Core0 > Core2: explode_generateTensors_arra__13 
		sendEnd(); // Core0 > Core2: explode_generateTensors_arra__13 
		cache_wbInv(explode_generateTensors_arra__11, 2097152*sizeof(char));
		sendStart(5); // Core0 > Core5: explode_generateTensors_arra__11 
		sendEnd(); // Core0 > Core5: explode_generateTensors_arra__11 
		...
		sendStart(3); // Core0 > Core3: explode_generateTensors_arra__3 
		sendEnd(); // Core0 > Core3: explode_generateTensors_arra__3 
		...
		cache_wbInv(explode_generateTensors_arra__0, 2097152*sizeof(char));
		...
		cache_wbInv(explode_generateTensors_arra__10, 2097152*sizeof(char));
		sendStart(6); // Core0 > Core6: explode_generateTensors_arra__10 
		sendEnd(); // Core0 > Core6: explode_generateTensors_arra__10 
		...
		receiveStart(); // Core7 > Core0: broadcastTensorB_0__multiply__4 
		receiveEnd(7); // Core7 > Core0: broadcastTensorB_0__multiply__4 
		...
		cache_inv(broadcastTensorB_0__multiply__6, 16777216*sizeof(char));
		multiply(2048/*rowsA*/,2048/*columnsA*/,2/*depthA*/,2048/*rowsB*/,2048/*columnsB*/,2/*depthB*/,arrayA_1048576__arrayA__0,output_8388608__arrayB__1,arrayC__arrayC_1048576__0); // multiplyTensors_2
		...
		sendStart(7); // Core0 > Core7: multiplyTensors_2__implode_d__0 
		sendEnd(); // Core0 > Core7: multiplyTensors_2__implode_d__0 
		multiply(2048/*rowsA*/,2048/*columnsA*/,2/*depthA*/,2048/*rowsB*/,2048/*columnsB*/,2/*depthB*/,arrayA_3145728__arrayA__0,output_25165824__arrayB__0,arrayC__arrayC_3145728__0); // multiplyTensors_6
