...
extern char *const broadcastTensorB_1__multiply__6;  // broadcastTensorB_1 > multiplyTensors_9 size:= 256*char defined in Core0
extern char *const broadcastTensorB_1__multiply__1;  // broadcastTensorB_1 > multiplyTensors_8 size:= 256*char defined in Core0
...
extern int *const output_0__arrayB__1;  // broadcastTensorB_1_output_0 > multiplyTensors_8_arrayB size:= 64*int defined in Core0
...
void core4(void){
	...
	while(1){
		...
		receiveStart(); // Core0 > Core4: broadcastTensorB_1__multiply__6 
		receiveEnd(0); // Core0 > Core4: broadcastTensorB_1__multiply__6 
		cache_inv(broadcastTensorB_1__multiply__6, 256*sizeof(char));
		receiveStart(); // Core0 > Core4: broadcastTensorB_1__multiply__1 
		receiveEnd(0); // Core0 > Core4: broadcastTensorB_1__multiply__1 
		cache_inv(broadcastTensorB_1__multiply__1, 256*sizeof(char));
		multiply(8/*rowsA*/,8/*columnsA*/,2/*depthA*/,8/*rowsB*/,8/*columnsB*/,2/*depthB*/,arrayA_64__arrayA__0,output_0__arrayB__1,arrayC__arrayC_64__0); // multiplyTensors_8
		...
		sendStart(7); // Core4 > Core7: multiplyTensors_8__implode_d__0 
		sendEnd(); // Core4 > Core7: multiplyTensors_8__implode_d__0 
		multiply(8/*rowsA*/,8/*columnsA*/,2/*depthA*/,8/*rowsB*/,8/*columnsB*/,2/*depthB*/,arrayA_72__arrayA__0,output_64__arrayB__1,arrayC__arrayC_72__0); // multiplyTensors_9
